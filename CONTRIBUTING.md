...
state income tax, ACA subsidies for pre-Medicare coverage, Medicaid spend-down, a house as an
asset — mortgage, appreciation, reverse mortgage (a planned *sale* is enterable as one-time
income, and long-term care itself is modeled as a stress test), long-term care insurance, probabilistic
